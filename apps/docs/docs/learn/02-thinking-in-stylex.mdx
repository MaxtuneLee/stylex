...
StyleX ESlint rule can be configured to allow or disallow certain CSS properties
within a project. This can be used in concert with static types to create
styling rules for a project.
